...
import { GetPayrollTargetsByUserIdQuery } from '@apps/api/payroll/application';

export class GetPayrollTargetsByUserIdRequest {
  ...
  toQuery(userId: string, contextUser: ContextUser): GetPayrollTargetsByUserIdQuery {
    return {
