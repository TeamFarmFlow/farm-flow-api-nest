...
echo "[INFO] removing existing container if exists: $CONTAINER_NAME"
remove_container_if_exists "$CONTAINER_NAME"

echo "[INFO] starting worker container: $CONTAINER_NAME"
docker run -d \
  --name "$CONTAINER_NAME" \
...
echo "[INFO] active container: $CONTAINER_NAME"
