...
import { GetMyAttendancesQuery } from '@app/feature/attendance/application';

export class GetMyAttendancesRequest {
  ...
  toQuery(farmId: string, userId: string): GetMyAttendancesQuery {
    return {
      farmId,
      userId,
