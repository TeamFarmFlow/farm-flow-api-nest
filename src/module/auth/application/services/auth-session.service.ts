...
import { AUTH_ACCESS_TOKEN_ISSUER, AUTH_REFRESH_TOKEN_STORE, AuthAccessTokenIssuerPort, AuthRefreshTokenStorePort } from '../ports';
...
export class AuthSessionService {
  ...
  async issueAuthTokens(userId: string, farmId: string | null = null): Promise<AuthTokensResult> {
    return {
  ...
  async rotateRefreshToken(refreshTokenId: string, userId: string, farmId: string | null = null): Promise<AuthTokensResult> {
